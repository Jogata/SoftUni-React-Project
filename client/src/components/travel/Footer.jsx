...
import lady2 from "./images/agent2.jpg";
import man1 from "./images/agent1.jpg";
import man2 from "./images/agent3.jpg";
...
export function Pricing() {
    return (
        <div className="pricing-container">
            <h2 className="pricing-title font">Pricing Plans</h2>
