            ...
            <div className="header-section">
              ...
              <div className="header-content">
                <div className="main-description">
                  ...
                  <p>Skyrim has a vast open-world map that features a variety of environments to explore and sights to behold. Players are able to fast travel to places they have already discovered through their map or to undiscovered cities through paid carriages found at several city gates. This page is an overview of all of the locations in Skyrim and each of the nine <Link to="/skyrim-holds" className="link">Holds</Link> found in the region, as well as the island of Solstheim. You may navigate to each specific page to find out more about the locale and its available Quests, services and Items.</p>
                </div>
                <div className="image">
